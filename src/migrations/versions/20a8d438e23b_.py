...
def upgrade():
    ...
    op.add_column('usuario', sa.Column('habilitado', sa.Boolean(), nullable=True))
    op.execute('UPDATE usuario SET habilitado = true')
    op.alter_column('usuario', 'habilitado', nullable=False)
